...
library.themes = {
    {
        ...
        theme = {
            ...
            ['Option Border 2']           = fromrgb(50,50,50);
    ...
    },
    {
        ...
        theme = {
            ...
            ['Option Text 3']             = fromrgb(145,145,145);
            ['Option Border 1']           = fromrgb(0,0,0);
            ['Option Border 2']           = fromrgb(60,53,93);
    ...
    },
    {
        ...
        theme = {
            ...
            ['Option Text 3']             = fromrgb(145,145,145);
            ['Option Border 1']           = fromrgb(0,0,0);
            ['Option Border 2']           = fromrgb(47,47,47);
            ['Option Background']         = fromrgb(35,35,35);
            ["Risky Text"]                = fromrgb(175, 21, 21);
            ["Risky Text Enabled"]        = fromrgb(255, 41, 41);
        }
    },
    {
        ...
        theme = {
            ...
            ['Option Text 3']             = fromrgb(145,145,145);
            ['Option Border 1']           = fromrgb(0,0,0);
            ['Option Border 2']           = fromrgb(45,45,45);
...
do
    ...
    function utility:UDim2ScaleToOffset(parent, udim2)
    ...
    function self.NewWindow(data)
            ...
            function tab:AddSection(text, side, order)
                ...
                function section:AddSeparator(data)
                    ...
                    do
                        ...
                        objs.border4 = utility:Draw('Square', {
                            Size = newUDim2(1,2,1,2);
                            Position = newUDim2(0,-1,0,-1);
                            ZIndex = z-1;
                            Parent = objs.border2;
                ...
                -- // Multidrop 
                function section:AddMultidrop(data)
                    local list = {
                        class = 'multidrop';
                        flag = data.flag;
                        text = '';
        ...
        function window:UpdateTabs()
            ...
            for i,v in next, self.tabs do
                ...
                -- objs.background.Size = newUDim2(0, objs.text.TextBounds.X + (utility:UDim2ScaleToOffset(window.objects.tabHolder, UDim2.new(1, 0, 0, 0)).X.Offset - tab_settings.textLength - ((#self.tabs - 1) * tab_settings.gap)) / #self.tabs, 1, v.selected and 1 or 0);
                -- objs.background.Position = newUDim2(0, pos, 0, 0)
                objs.background.Size = newUDim2(1 / #self.tabs, ((i == 1) and 1 or (i == #self.tabs and -2 or -1) - tab_settings.gap), 1, v.selected and 1 or 0)
                objs.background.Position = newUDim2(1 / (#self.tabs / (i - 1)), (i == 1 and 0 or 2 + tab_settings.gap), 0, 0)

                objs.text.ThemeColor = v.selected and 'Accent' or 'Primary Text';
                objs.text.Position = newUDim2(.5, 0, 0, 3);


                pos += objs.background.Size.X.Offset + tab_settings.gap
