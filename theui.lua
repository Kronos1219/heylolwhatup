...
do 
    ...
    do 
        ...
        local toggle = {} do 
            ...
            toggle.toggle = function(self, state) 
            ...
            toggle.signals = {
                backToggle = {
                    ...
                    MouseButton1Click = function(inst, toggle) 
                        local state = not toggle.toggled
                        toggle:toggle(state or false)
                    end
                }
            }
    ...
    do 
        local dropdown = {} do 
            ...
            dropdown.selectOption = function(self, option)
                ...
                print(control['#click-sensor']['#button']['#label'].Text)
                control['#click-sensor']['#button']['#label'].Text = self.name .. ': ' .. option
    ...
    do 
        local multidropdown = {} do 
            ...
            multidropdown.selectOption = function(self, option)
                ...
                for i,v in next, menu:GetChildren() do 
                    if v.Name == '#click-sensor' and v:FindFirstChild('#button') and v['#button']:FindFirstChild('#label') then 
                        local label = v['#button']['#label']
                        
                        if label.Text == option then 
                            clickSensor = v 
                            button = v['#button']
                        end
                    end
                ...
                self:fireEvent('optionClick', self)
                tween(button, {BackgroundColor3 = theme.Button4}, 0.2, 1)
                tween(clickSensor['#button']['#stroke'], {Color = theme.StrokeHover}, 0.2, 1)
            end
            
            multidropdown.selectOptions = function(self, options)
            ...
            textbox.signals = {
                ...
                textBox = {
                    ...
                    FocusLost = function(inst, obj) 
                        ...
                        local inputText = tostring(inst.Text)
                        inst.Text = inputText
    ...
    do 
        local hotkey = {} do 
            ...
            hotkey.click = function(self) 
                ...
                self.inputCon = inputService.InputBegan:Connect(function(io, gpe) 
                    ...
                    if (kc == 'Unknown' or kc == 'Escape') then 
                        ...
                        self:fireEvent('onKey', hotkey.key)
                        self.inputCon:Disconnect()
                        self.inputCon = nil 
            ...
            hotkey.keyFired = function(self)
                onKeyFired = inputService.InputBegan:Connect(function(io, gpe)
                    local kc = io.KeyCode.Name
                    
                    if self.hotkey == io.KeyCode then 
                        self:fireEvent('onKey', kc)
                    end
                end)
            end
            ...
            hotkey.setHotkey = function(self, hotkey) 
                if (hotkey) then 
                    ...
                    self:fireEvent('onKey', self.callback)
                else
                    self.hotkey = nil
            ...
            elemClasses.section.addHotkey = function(self, settings) 
                ...
                if (typeof(callback) == 'function') then
                    hotkey:bindToEvent('onKey', callback)
                    hotkey:keyFired()
                end
